...
-- 4. Ajout des tenants
INSERT INTO adam.tenants_per_users (tenant_id, pg_user) VALUES ('tenantA', 'adam_test');
INSERT INTO adam.tenants_per_users (tenant_id, pg_user) VALUES ('tenantB', 'adam_test');

-- 5. Ajout des droits sur la tables
GRANT USAGE ON SCHEMA qfq TO adam_test;
GRANT SELECT ON ALL TABLES IN SCHEMA qfq TO adam_test;
