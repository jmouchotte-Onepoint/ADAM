CREATE OR REPLACE FUNCTION fn_trigger_check_rules_from_model()
RETURNS TRIGGER AS $$
DECLARE
    v_model_rule RECORD;
BEGIN
    ...
    FOR v_model_rule IN EXECUTE 'SELECT * FROM model_rules WHERE model_id = $1' USING NEW.model_id
        LOOP
            ...
            IF NOT fn_check_dynamic_rules(v_model_rule.rule_id, v_model_rule.params) THEN
